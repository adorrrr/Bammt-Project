...
export const NotFoundPage: React.FC = () => {
  return (
    <div className="min-h-[65vh] py-16 flex flex-col items-center justify-center text-center">
      <Container size="sm">
        <div className="w-16 h-16 rounded-full bg-gangchill-surface border border-gangchill-border flex items-center justify-center mx-auto mb-4 text-gangchill-earth">
        ...
        <Link
          to="/"
          className="inline-flex items-center gap-2 px-6 py-3 rounded-natural bg-gangchill-green text-white font-bold text-sm hover:bg-gangchill-green-deep transition-all shadow-xs"
        >
